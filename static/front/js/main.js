...
/*------------------------------------------------------------------------------*/
    ...
    $(window).scroll(function(){
        ...
        if ( matchMedia( 'only screen and (min-width: 1200px)' ).matches ) 
        {
            if ($(window).scrollTop() >= 50 ) {
                ...
                $('.ttm-stickable-header').addClass('fixed-header');
                $('.header.ttm-header-style-classic-overlay .ttm-stickable-header').addClass('fixed-header').find('img').attr({src:'./images/logo/logo-full.png'});;

            }
            else {

                $('.ttm-stickable-header').removeClass('fixed-header');
                $('.header.ttm-header-style-classic-overlay .ttm-stickable-header').removeClass('fixed-header').find('img').attr({src:'./images/logo/logo-full.png'});;
    ...
    $(document).ready(function() {
        ...
        if ( matchMedia( 'only screen and (min-width: 1200px)' ).matches ) 
            {
                $('.header.ttm-header-style-classic-overlay').find('img').attr({src:'./images/logo/logo-full.png'});
            }
    ...
    jQuery(window).resize(function() {
        ...
        if ( matchMedia( 'only screen and (max-width: 1200px)' ).matches ) {
            ...
            $('.header.ttm-header-style-classic-overlay').find('img').attr({src:'./images/.png'});  
        }
